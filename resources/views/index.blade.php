...
<main class="main">
    ...
    <div class="page">
        <div class="movies-list">
            <h1 class="h1">Trending Movies</h1>
            <div class="inner">
                @foreach($movies as $movie)
                    <div class="movie-container">
                        @auth
                            @if ($usersMovies->contains('movie_id', $movie['id']))
                                <button class="addButton added" form="{{ $movie['id'] }}"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <g id="Icon_feather-plus" data-name="Icon feather-plus"
                                           transform="translate(-6 -6)">
                                            <path id="Path_1" data-name="Path 1" d="M18,7.5v21" fill="none"
                                                  stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                                  stroke-width="3"/>
                                            <path id="Path_2" data-name="Path 2" d="M7.5,18h21" fill="none"
                                                  stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                                  stroke-width="3"/>
                                        </g>
                                    </svg>
